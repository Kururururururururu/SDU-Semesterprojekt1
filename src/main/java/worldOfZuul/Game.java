...
public class Game {
    ...
    private void createRooms() {
        ...
        hub = new Room("Hub", 0, 0,0);
        dh = new Room("Dirty Hills", 1, 0,0);
        wt = new Room("Windy Town", 2, 2,2);
        sc = new Room("Solar City", 3, 3,1);
        c = new Room("Coast", 4, 0,0);
        no = new Room("New Orleans", 5, 2,0);
